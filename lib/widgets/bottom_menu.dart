...
class BottomMenu extends StatelessWidget {
  ...
  const BottomMenu({Key? key, required this.songModel}) : super(key: key);
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: value.selectedIndex == -1
                                  ...
                                  : Marquee(
                                      text: snapshot.data![value.selectedIndex]
                                          .displayName,
              ...
              builder: (context, snapshot) {
                ...
                return Padding(
                  ...
                  child: ProgressBar(
                    ...
                    total: playerService.audioPlayer.duration ?? Duration.zero,
                    onSeek: (value) {
                    ...
                    return InkWell(
                      onTap: () async {
                        ...
                        if (value.selectedIndex == songs.length - 1) {
                          playerService.playNext(songs[0].data, songs.length);
